                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <div class="content">
                                            ...
                                            <p>
                                                <j:choose>
                                                    <j:when test="${ document.data()[4] == 'Free'}"><span
                                                            class="tag is-success">Free</span></j:when>
                                                    <j:when test="${ document.data()[4] == 'Borrowed'}"><span
                                                            class="tag is-danger">Borrowed</span></j:when>
                                                </j:choose>
                                            </p>
                                        </div>
                                    </div>
